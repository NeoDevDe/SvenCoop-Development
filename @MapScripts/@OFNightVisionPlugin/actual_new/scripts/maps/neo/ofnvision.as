...
* |==============================================================================|
* | OF NightVision activation from map cfg file ('<map-name>.cfg'):              |
* |------------------------------------------------------------------------------|
* | => To enable OF NightVision add:   as_command nvision 1                      |
* | => To disable OF NightVision add:  as_command nvision 0                      |
* |==============================================================================|
*/
...
final class NightVision
{
	...
	private Vector m_vColor( 0, 255, 0 );
