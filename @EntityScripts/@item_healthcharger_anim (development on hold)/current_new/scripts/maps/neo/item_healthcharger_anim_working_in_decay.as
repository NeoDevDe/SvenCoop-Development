...
class item_healthcharger_pillar : ScriptBaseAnimating
{
	...
	private string m_szModelName	= "models/neo/health_charger_pillar.mdl";
...
class item_healthcharger_anim : ScriptBaseAnimating
{
	...
	private item_healthcharger_pillar@ pBottle;
	private string 	m_szModelName    = "models/neo/health_charger_body.mdl";
...
/*
void RegisterItemHealthChargerAnimEntity(bool bReplace=true)
{
    g_CustomEntityFuncs.RegisterCustomEntity( "item_healthcharger_pillar", "item_healthcharger_pillar" );
    g_CustomEntityFuncs.RegisterCustomEntity( "item_healthcharger_anim", (bReplace ? "item_healthcharger" : "item_healthcharger_anim"));
}
